#!/usr/bin/env python3
"""
Update Persian Pie Joint on Shopify.
"""

from shopify_api import update_product_description, create_or_update_metafield, get_product
import sys

PRODUCT_ID = "9035179032788"

# Description
DESCRIPTION = """
Persian Pie Joint combines the zesty citrus of Lemon Tree with the sweet, creamy depth of Banana Krumble. This vigorous hybrid delivers an explosion of fruity flavours, starting with fresh lemon and ending with earthy, caramelized banana notes. The effects are balanced yet potent, offering heavy body relaxation coupled with a creative, cerebral buzz—perfect for unwinding with a smile.
"""

TAGS = ["Joint", "Hybrid", "Persian Pie", "Relaxed", "Creative", "Fruity", "New Strains", "Pre-roll"]
...
def main():
    print(f"🚀 Updating Persian Pie Joint (ID: {PRODUCT_ID})...")
    print("=" * 60)
