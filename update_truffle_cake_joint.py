#!/usr/bin/env python3
"""
Update Truffle Cake Joint metafields
"""
...
product_id = "9009298309332"

# List type metafields
list_fields = {
    "lineage": "Gorilla Butter F2 x Pancakes (In House Genetics creation)",
    "flowering_time": "8–9 weeks",
    "effects": "Uplifting cerebral rush • Euphoric • Happy • Relaxing body high • Creative",
    "breeder": "In House Genetics (premium hybrid genetics)",
}
...
single_fields = {
    ...
    "flavours": "Sugary fruity candy, vanilla cake, earthy truffle, creamy butter",
    "used_for": "Socializing, creative focus, mood elevation, stress relief, relaxation",
}

print("🚀 Updating Truffle Cake Joint metafields...")
